...
//Block Info
extern int blocksize, numblocks;
extern int *blockowners;
...
void set_defaults(void) {
	...
	instr_num = 0;
	schedint = malloc(2000 * sizeof(interrupt));
	sched_count = 0;
	
	blocksize = 512;
	numblocks = sectors * tracks * heads;
	blockowners = calloc(numblocks, sizeof(int));
}
